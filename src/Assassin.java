...
public class Assassin implements Characters {
    private String name;
    private int health;
    private int Mana;
    ...
    public Assassin(String name, int health,int Mana, int fullSpeed, int strength) {
        this.name = name;
        this.health = health;
        this.Mana = Mana;
    ...
    public void displayStats() {
        System.out.println("Assassin Name: " + name);
