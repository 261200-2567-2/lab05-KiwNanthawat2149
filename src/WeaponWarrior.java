public class WeaponWarrior implements Weapon {
    private String name;
    private int Strengthweapon;
    private int Speedweapon;
    private int Manaweapon;

    public WeaponWarrior(String name, int Strengthweapon, int Speedweapon, int Manaweeapon ) {
        this.name = name;
        this.Strengthweapon = Strengthweapon;
        this.Speedweapon = Speedweapon;
        this.Manaweapon = Manaweeapon;
    }
